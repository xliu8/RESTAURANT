...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-3">
        <button type="button" class="button text-white" onclick="location.href='/web2/Restaurant/admin/menu_create.php'">Create a new</button>
    <div>
    <!--Menu Display-->
    <div class="all_menu background-c" >
        <div class="menu_post">
            <?php foreach ($menuItems as $menu): ?>
                <div class="menu_item">
                    <h3 class="food_title">
                    <a class="edit" href="menu_edit.php?food_id=<?= $menu['food_id'] ?>">edit</a>
                        <a class="text-white" href="menu_edit.php?food_id=<?= $menu['food_id'] ?>"><?= $menu['food_name'] ?></a>
                    </h3>
                </div>
            <?php endforeach; ?>
        </div>
