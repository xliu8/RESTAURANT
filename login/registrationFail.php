    ...
    <!--nav bar-->
        <div class="nav-bar d-flex justify-content-center">
            <nav class="nav nav-pills nav-fill ">
                ...
                <a class="nav-link text-white" href="/web2/Restaurant/login/login.php">Login</a>
            </nav>
        </div>
    </div>

    <div class="background-c pt-5 pb-5 ">
        <h6 class="text-white pt-5 d-flex justify-content-center">Invalid or Dupilicated information, please check and re-enter it.</h6>
        <a href="registration.php"><p class="text-white d-flex justify-content-center">Return to Register</p></a>
    </div>
