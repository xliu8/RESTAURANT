...
<html lang="en">
  ...
  <body>
    ...
    <div class="background-c pt-5 pb-5 ">
        <h6 class="text-white pt-5 d-flex justify-content-center">Invalid Password or Username, please check and re-enter it.</h6>
        <a href="login.php"><p class="text-white d-flex justify-content-center">Return to login</p></a>
    </div>
